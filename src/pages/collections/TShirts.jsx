        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <ScrollAnimation yOffset={30}>
              <h1 className="text-3xl font-bold font-monument">T-Shirts</h1>
              <p className="text-gray-600 mt-2">{filteredProducts.length} T-shirts</p>
            </ScrollAnimation>
            <ScrollAnimation delay={0.1} yOffset={20}>
              <div>
                ...
                <select
                  ...
                  className="text-sm md:w-64 px-4 py-2 shadow-md border border-gray-300 rounded-md"
                >
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center text-gray-600 py-8">
              <p className="text-lg font-medium">No T-shirts match your selected price range.</p>
              <p className="text-sm mt-2">Try adjusting the price range to see more T-shirts.</p>
            </div>
          ) : (
            <>
