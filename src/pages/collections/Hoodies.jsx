        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <ScrollAnimation yOffset={30}>
              ...
              <p className="text-gray-600 mt-2">{filteredProducts.length} hoodies</p>
            </ScrollAnimation>
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center text-gray-600 py-8">
              <p className="text-lg font-medium">No hoodies match your selected price range.</p>
              <p className="text-sm mt-2">Try adjusting the price range to see more hoodies.</p>
            </div>
          ) : (
            <>
